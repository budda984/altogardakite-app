...
-- FASE 2: usa il nuovo enum 'corso', aggiunge servizi listino, flag cartaceo
--
-- PREREQUISITO: il file 0009_add_corso_enum.sql deve essere stato eseguito
-- e committato in una sessione precedente.
-- ============================================================================
